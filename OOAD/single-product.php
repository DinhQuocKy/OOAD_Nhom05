            ...
            <div class="row">
                ...
                <div class="col-md-8">
                                ...
                                <div role="tabpanel">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <?php
                                            ...
                                            if(isset($_POST['rating']) && isset($_SESSION['ID']) && $_POST['review']!=NULL){
                    ...
                    <?php 
                        $id_sach =$_GET['id'];
                        include_once 'dbconnect.php';
                        $query = "select N.HoTen,B.* from binhluan as B join nguoidung as N on N.ID = B.ID_DocGia where B.ID_Sach = '$id_sach'";
                        $result = new Connection();
